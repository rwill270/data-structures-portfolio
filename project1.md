...
### Dataset
The primary data source will be NBA Stats on the ESPN NBA page. I can extract specific variables like field goal percentage, PPG, and whether the team is home or away that game. I can also sort the data to show games that fall on back to back days.
